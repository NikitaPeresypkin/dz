...
public class Main {
    public static void main(String[] args) {
        ...
        personArry[3] = new Сотрудник("Шмидт Олег Андреевич", "Преподаватель", "Scholeg@gmail.com", 610242, 60000, 51);
        personArry[4] = new Сотрудник("Попова Надежда Михайловна", "Повар", "podezda@gmail.com", 620242, 71000, 33);
        for (var i = 0; i < (personArry.length); i++) personArry[i].someInfo();

        task(3);
        Park luna = new Park("Луна", "ул. Ленина 25");
        luna.parkAttractionsInfo();
    }
